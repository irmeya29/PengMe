...
<div class="container py-4" style="max-width: 720px;">
  ...
  <div class="card card-shell">
    ...
    <form method="post" action="{{ route('admin.users.store') }}" class="p-3 p-md-4">
      @csrf

      {{-- Nom --}}
      <div class="form-floating mb-3">
        <input type="text" name="name" id="name" class="form-control" placeholder="Nom" required value="{{ old('name') }}">
